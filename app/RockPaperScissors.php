...
<head>
	...
	<title>Vapor Games: Rock Paper Scissors</title>
				...
				<div class="container">
					<a href="index.php" class="branding">
						<?php if (isset($_SESSION["username"])) { ?>
							...
							<div class="logo-type">
								<h1 style="margin-top:45px" class="site-title">Vapor Games: Rock Paper Scissors</h1>
								<small class="site-description">University of Michigan - Dearborn</small>
							</div>
						<?php  } else { ?>
							<img src="images/logo.png" alt="" class="logo">
							<div class="logo-type">
								<h1 class="site-title">Vapor Games: Rock Paper Scissors</h1>
								<small class="site-description">University of Michigan - Dearborn</small>
							</div>
						<?php } ?>
					</a>
<div id="wrapper">
	...
	<div id="main">
		...
		<?php if (isset($_SESSION["username"])) { ?>
		<center><a href="Games/Rock Paper Scissors.zip" download>
