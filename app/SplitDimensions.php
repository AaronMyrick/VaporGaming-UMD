...
<head>
	...
	<title>Vapor Games: Split Dimensions</title>
				...
				<div class="container">
					<a href="index.php" class="branding">
						<?php if (isset($_SESSION["username"])) { ?>
							...
							<div class="logo-type">
								<h1 style="margin-top:45px" class="site-title">Vapor Games: Split Dimensions</h1>
								<small class="site-description">University of Michigan - Dearborn</small>
							</div>
						<?php  } else { ?>
							<img src="images/logo.png" alt="" class="logo">
							<div class="logo-type">
								<h1 class="site-title">Vapor Games: Split Dimensions</h1>
								<small class="site-description">University of Michigan - Dearborn</small>
							</div>
						<?php } ?>
					</a>
<div id="wrapper">
	...
	<div id="main">
		...
		<?php if (isset($_SESSION["username"])) { ?>
		<center><a href="Games/Split Dimensions.zip" download>
...
var DoLoad = function()
{
	...
	Module = { TOTAL_MEMORY: 1024*1024*150, TOTAL_STACK: 1024*1024*5, currentScriptUrl: '-', preInit: DoExecute };
	var s = document.createElement('script'), d = document.documentElement;
	s.src = 'Split Dimensions.js';
	s.async = true;
